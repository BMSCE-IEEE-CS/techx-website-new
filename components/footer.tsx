    ...
    return (
        <footer className="bg-black text-white py-8">
            <div className="container mx-auto px-4">
                    ...
                    <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-8">
                        <div className="flex-1 text-center lg:text-left flex flex-col items-center lg:items-start">
                            <div className="w-full h-48 lg:h-64">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1944.2409090360702!2d77.5649372349438!3d12.940991383495657!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae158b11e34d2f%3A0x5f4adbdbab8bd80f!2sBMS%20College%20of%20Engineering!5e0!3m2!1sen!2sin!4v1723282951998!5m2!1sen!2sin" width="100%" height="100%" style={{ border: "0" }} allowFullScreen={false} loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                            <h3 className="text-xl font-bold mt-4 mb-2 lg:mb-0 ml-[6%]">B.M.S. College of Engineering</h3>
                            <div className="flex justify-center w-full mt-2">
                                <a href="https://linktr.ee/bmsce_ieeecs" target="_blank" rel="noopener noreferrer">
                        ...
                        <div className="flex-1 text-center lg:text-left flex flex-col items-center lg:items-start">
                            <div className="w-full h-48 lg:h-64">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3889.6925424903943!2d77.4356121852999!3d12.863124093954529!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae472f365fe219%3A0xcae219b3b46324db!2sCHRIST%20(Deemed%20to%20be%20University)%20Bengaluru%20Kengeri%20Campus!5e0!3m2!1sen!2sin!4v1723283048620!5m2!1sen!2sin" width="100%" height="100%" style={{ border: "0" }} allowFullScreen={false} loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                            <h3 className="text-xl font-bold mt-4 mb-2 lg:mb-0 text-center">Christ(Deemed to be University), Kengeri Campus</h3>
                            <div className="flex justify-center w-full mt-2">
                                <a href="https://linktr.ee/bmsce_ieeecs" target="_blank" rel="noopener noreferrer">
                ...
                <div className="text-center mt-8">
                    ...
                    <div className="flex justify-center space-x-4 mt-2">
                        <a href="https://www.facebook.com/cs.techx/" target='_blank' style={iconStyle}>
                            <FaFacebookF />
                        </a>
                        <a href="https://www.instagram.com/cs.techx" target='_blank' style={iconStyle}>
                            <FaInstagram />
                        </a>
                        <a href="https://www.linkedin.com/company/cs-techx" target='_blank' style={iconStyle}>
                            <FaLinkedinIn />
                        </a>
                        <a href="http://syp.computer.org/techx" target='_blank' style={iconStyle}>
                            <FaGlobe />
                        </a>
                    </div>
                </div>
            ...
            <p className="text-lg md:text-xl text-body-color dark:text-dark-6 text-center mt-10">
                <span className="text-xl md:text-2xl">&copy;</span> TechX. All rights reserved
            </p>
        </footer>
    );
};
